...
class UserRegisterValidatorSpec extends FlatSpec with Matchers {
  "validate" should "accept valid data" in {
    val dataIsValid = UserRegisterValidator.validate("login", "admin@hiking.com", "password")

    dataIsValid shouldBe Right(())
  }

  "validate" should "not accept login containing only empty spaces" in {
    val dataIsValid = UserRegisterValidator.validate("   ", "admin@hiking.com", "password")
  ...
  "validate" should "not accept too short login" in {
    ...
    val dataIsValid   = UserRegisterValidator.validate(tooShortLogin, "admin@hiking.com", "password")
  ...
  "validate" should "not accept too short login after trimming" in {
    ...
    val dataIsValid            = UserRegisterValidator.validate(loginTooShortAfterTrim, "admin@hiking.com", "password")
  ...
  "validate" should "not accept password with empty spaces only" in {
    val dataIsValid = UserRegisterValidator.validate("login", "admin@hiking.com", "    ")
